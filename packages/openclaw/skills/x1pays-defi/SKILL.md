...
Example: "Buy 5 USDC.x worth of wXNT every day at 9am"
1. Create a cron job that calls x1pays_swap with input_token="USDC.x", output_token="WXNT", amount="5"
...
Example: "Alert me when wXNT drops below 0.5 USDC.x"
- The price monitor watches the WXNT/USDC.x pool
...
Example: "Keep my portfolio 50/50 between USDC.x and wXNT"
